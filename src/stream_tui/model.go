...
const (
	...
	MissingFileOverwriteLabel = "Allow DesktopCleaner to overwrite this file"
)

var promptChoices = []internal.RespondMissingFileChoice{
	internal.RespondMissingFileChoiceLoad,
	internal.RespondMissingFileChoiceSkip,
	internal.RespondMissingFileChoiceOverwrite,
}
