...
func current(cmd *cobra.Command, args []string) {
	...
	currentBranchesByPlanId, err := api.Client.GetCurrentBranchByPlanId(lib.CurrentProjectId, internal.GetCurrentBranchByPlanIdRequest{
