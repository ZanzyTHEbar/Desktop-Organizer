...
const (
	SignInCloudOption = "DesktopCleaner Cloud"
	SignInOtherOption = "Another host"
)

func promptSignInNewAccount() error {
	selected, err := term.SelectFromList("Use DesktopCleaner Cloud or another host?", []string{SignInCloudOption, SignInOtherOption})
